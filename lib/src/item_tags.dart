...
class _ItemTagsState extends State<ItemTags> {
  ...
  void _setDataList() {
    ...
    // set List length
    if (_dataListInherited != null &&
        _dataListInherited!.list.length <
            _dataListInherited!.itemCount) if (_dataListInherited!
                .list.length >
            (widget.index + 1) &&
    ...
    if (_dataListInherited != null &&
        _dataListInherited!.list.length < (widget.index + 1)) {
      //print("add");
    ...
    if (_dataListInherited != null &&
        _dataListInherited!.itemCount == widget.index + 1 &&
  ...
  Widget build(BuildContext context) {
    ...
    Color color = _dataList == null || !_dataList!.active
        ? widget.color
        : widget.activeColor;
    if (_dataList != null && _dataList!.showDuplicate)
  ...
  Widget get _combine {
    assert((widget.image?.child == null) || (widget.image?.image == null));
    ...
    if (widget.removeButton != null && _dataListInherited != null )
      return Row(
            ...
            child: FittedBox(
              ...
              child: GestureDetector(
                child: Container(
                  ...
                  padding: (widget.removeButton?.padding ?? EdgeInsets.all(2)) *
                  ...
                  child: widget.removeButton?.padding == null
                      ? Icon(
                          Icons.clear,
  ...
  TextStyle get _textStyle {
    return widget.textStyle.apply(
      color: _dataList == null || !_dataList!.active
          ? widget.textColor
